...
# Semantic Annotations (Views) — Self Assessment
...
questions = [
    {
      "question": "What is a View in the semantic world?",
      ...
      "explanation": "Views encode semantic meaning (e.g., Apple, Container) on top of kinematic entities."
    },
    {
      "question": "How does the Apple view example set a default name?",
      "type": "multiple_choice",
      "answers": [
      ...
      "explanation": "Apple(View) sets name in __post_init__ using PrefixedName if none is provided."
    },
    {
      "question": "Which library is used to query for views like apples?",
      "type": "multiple_choice",
      "answers": [
      ...
      "explanation": "EQL constructs queries such as an(entity(let(Apple, world.views)))."
    },
    {
      "question": "What does the FruitBox view group together in the example?",
      "type": "multiple_choice",
      "answers": [
        {"answer": "A Container and a list of Apple views", "correct": True},
      ...
      "explanation": "FruitBox(View) aggregates a Container view and several Apple views."
    },
    {
      ...
      "explanation": "ContainerFactory is used to create a hollowed out container body and view."
    }
]
