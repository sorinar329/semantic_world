...
class FloorDAO(
    SupportingSurfaceDAO, DataAccessObject[semantic_world.views.views.Floor]
):
...
class TwoArmedAbstractRobotDAO(
    AbstractRobotDAO, DataAccessObject[semantic_world.robots.TwoArmedAbstractRobot]
):
...
class TracyDAO(TwoArmedAbstractRobotDAO, DataAccessObject[semantic_world.robots.Tracy]):
    ...
    id: Mapped[int] = mapped_column(
        ForeignKey(TwoArmedAbstractRobotDAO.id), primary_key=True
    )
