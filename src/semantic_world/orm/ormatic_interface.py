...
import semantic_world.adapters.procthor
...
import trimesh.base
from semantic_world.adapters.procthor import Direction
...
class DresserFactoryDAO(Base, DataAccessObject[semantic_world.adapters.procthor.DresserFactory]):
    __tablename__ = 'DresserFactoryDAO'
    ...
    name_id: Mapped[int] = mapped_column(ForeignKey('PrefixedNameDAO.id', use_alter=True), nullable=True)
    container_factory_id: Mapped[int] = mapped_column(ForeignKey('ContainerFactoryDAO.id', use_alter=True), nullable=True)

    name: Mapped[PrefixedNameDAO] = relationship('PrefixedNameDAO', uselist=False, foreign_keys=[name_id], post_update=True)
    container_factory: Mapped[ContainerFactoryDAO] = relationship('ContainerFactoryDAO', uselist=False, foreign_keys=[container_factory_id], post_update=True)
    drawers_factories: Mapped[List[DrawerFactoryDAO]] = relationship('DrawerFactoryDAO', foreign_keys='[DrawerFactoryDAO.dresserfactorydao_drawers_factories_id]', post_update=True)
    drawer_transforms: Mapped[List[TransformationMatrixMappingDAO]] = relationship('TransformationMatrixMappingDAO', foreign_keys='[TransformationMatrixMappingDAO.dresserfactorydao_drawer_transforms_id]', post_update=True)
    door_factories: Mapped[List[DoorFactoryDAO]] = relationship('DoorFactoryDAO', foreign_keys='[DoorFactoryDAO.dresserfactorydao_door_factories_id]', post_update=True)
    door_transforms: Mapped[List[TransformationMatrixMappingDAO]] = relationship('TransformationMatrixMappingDAO', foreign_keys='[TransformationMatrixMappingDAO.dresserfactorydao_door_transforms_id]', post_update=True)
...
class TransformationMatrixMappingDAO(Base, DataAccessObject[semantic_world.orm.model.TransformationMatrixMapping]):
    ...
    dresserfactorydao_drawer_transforms_id: Mapped[Optional[int]] = mapped_column(ForeignKey('DresserFactoryDAO.id', use_alter=True), nullable=True)
    dresserfactorydao_door_transforms_id: Mapped[Optional[int]] = mapped_column(ForeignKey('DresserFactoryDAO.id', use_alter=True), nullable=True)
...
class DoorFactoryDAO(Base, DataAccessObject[semantic_world.adapters.procthor.DoorFactory]):
    __tablename__ = 'DoorFactoryDAO'

    id: Mapped[int] = mapped_column(Integer, primary_key=True)

    handle_direction: Mapped[semantic_world.adapters.procthor.Direction]


    dresserfactorydao_door_factories_id: Mapped[Optional[int]] = mapped_column(ForeignKey('DresserFactoryDAO.id', use_alter=True), nullable=True)
    name_id: Mapped[int] = mapped_column(ForeignKey('PrefixedNameDAO.id', use_alter=True), nullable=True)
    handle_factory_id: Mapped[int] = mapped_column(ForeignKey('HandleFactoryDAO.id', use_alter=True), nullable=True)
    scale_id: Mapped[int] = mapped_column(ForeignKey('ScaleDAO.id', use_alter=True), nullable=True)

    name: Mapped[PrefixedNameDAO] = relationship('PrefixedNameDAO', uselist=False, foreign_keys=[name_id], post_update=True)
    handle_factory: Mapped[HandleFactoryDAO] = relationship('HandleFactoryDAO', uselist=False, foreign_keys=[handle_factory_id], post_update=True)
...
class ContainerFactoryDAO(Base, DataAccessObject[semantic_world.adapters.procthor.ContainerFactory]):
    __tablename__ = 'ContainerFactoryDAO'

    id: Mapped[int] = mapped_column(Integer, primary_key=True)

    wall_thickness: Mapped[float]
    direction: Mapped[semantic_world.adapters.procthor.Direction]
...
class DrawerFactoryDAO(Base, DataAccessObject[semantic_world.adapters.procthor.DrawerFactory]):
    __tablename__ = 'DrawerFactoryDAO'

    id: Mapped[int] = mapped_column(Integer, primary_key=True)



    dresserfactorydao_drawers_factories_id: Mapped[Optional[int]] = mapped_column(ForeignKey('DresserFactoryDAO.id', use_alter=True), nullable=True)
    name_id: Mapped[int] = mapped_column(ForeignKey('PrefixedNameDAO.id', use_alter=True), nullable=True)
    handle_factory_id: Mapped[int] = mapped_column(ForeignKey('HandleFactoryDAO.id', use_alter=True), nullable=True)
    container_factory_id: Mapped[int] = mapped_column(ForeignKey('ContainerFactoryDAO.id', use_alter=True), nullable=True)
...
class HandleFactoryDAO(Base, DataAccessObject[semantic_world.adapters.procthor.HandleFactory]):
    __tablename__ = 'HandleFactoryDAO'
...
class AbstractRobotDAO(RootedViewDAO, DataAccessObject[semantic_world.robots.AbstractRobot]):
    ...
    odom_id: Mapped[int] = mapped_column(ForeignKey('BodyDAO.id', use_alter=True), nullable=True)
    torso_id: Mapped[Optional[int]] = mapped_column(ForeignKey('TorsoDAO.id', use_alter=True), nullable=True)

    odom: Mapped[BodyDAO] = relationship('BodyDAO', uselist=False, foreign_keys=[odom_id], post_update=True)
