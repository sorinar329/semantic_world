...
class BoundingBoxCollectionDAO(Base, DataAccessObject[
    semantic_world.world_description.geometry.BoundingBoxCollection]):
...
class CollisionCheckingConfigDAO(Base, DataAccessObject[
...
class KinematicStructureEntityDAO(WorldEntityDAO, DataAccessObject[
...
class TriangleMeshDAO(ShapeDAO, DataAccessObject[semantic_world.world_description.geometry.TriangleMesh]):
...
class RegionDAO(KinematicStructureEntityDAO, DataAccessObject[
    semantic_world.world_description.world_entity.Region]):
...
class ActiveConnectionDAO(ConnectionDAO, DataAccessObject[
    semantic_world.world_description.connections.ActiveConnection]):
...
class FixedConnectionDAO(ConnectionDAO, DataAccessObject[
    semantic_world.world_description.connections.FixedConnection]):
...
class PassiveConnectionDAO(ConnectionDAO, DataAccessObject[
    semantic_world.world_description.connections.PassiveConnection]):
...
class EnvironmentViewDAO(RootedViewDAO, DataAccessObject[
    semantic_world.world_description.world_entity.EnvironmentView]):
...
class ActiveConnection1DOFDAO(ActiveConnectionDAO, DataAccessObject[
    semantic_world.world_description.connections.ActiveConnection1DOF]):
...
class Connection6DoFDAO(PassiveConnectionDAO, DataAccessObject[
    semantic_world.world_description.connections.Connection6DoF]):
...
class KinematicChainDAO(RobotViewDAO, DataAccessObject[semantic_world.robots.KinematicChain]):
    ...
    tip_id: Mapped[int] = mapped_column(ForeignKey('KinematicStructureEntityDAO.id', use_alter=True), nullable=True)
...
class ManipulatorDAO(RobotViewDAO, DataAccessObject[semantic_world.robots.Manipulator]):
    ...
    tool_frame_id: Mapped[int] = mapped_column(ForeignKey('KinematicStructureEntityDAO.id', use_alter=True), nullable=True)

    tool_frame: Mapped[KinematicStructureEntityDAO] = relationship('KinematicStructureEntityDAO', uselist=False, foreign_keys=[tool_frame_id], post_update=True)
...
class PrismaticConnectionDAO(ActiveConnection1DOFDAO, DataAccessObject[
    semantic_world.world_description.connections.PrismaticConnection]):
...
class RevoluteConnectionDAO(ActiveConnection1DOFDAO, DataAccessObject[
    semantic_world.world_description.connections.RevoluteConnection]):
