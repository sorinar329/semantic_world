...
conclusion_type = (Container, Handle, Door, set, list, Drawer, Cabinet, Fridge,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Container, Handle, Door, Drawer, Cabinet, Fridge]]:
