...
conclusion_type = (Door, set, list, Container, Cabinet, Drawer, Fridge, Handle,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Door, Container, Cabinet, Drawer, Fridge, Handle]]:
