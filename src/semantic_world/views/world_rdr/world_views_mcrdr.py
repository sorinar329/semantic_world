...
conclusion_type = (Container, Drawer, Handle, set, Cabinet, list, Fridge, Door,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Container, Drawer, Handle, Cabinet, Fridge, Door]]:
