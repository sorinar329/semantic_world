...
conclusion_type = (Fridge, set, list, Cabinet, Door, Container, Handle, Drawer,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Fridge, Cabinet, Door, Container, Handle, Drawer]]:
