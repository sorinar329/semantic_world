...
conclusion_type = (Fridge, Door, set, Drawer, list, Cabinet, Container, Handle,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Fridge, Door, Drawer, Cabinet, Container, Handle]]:
