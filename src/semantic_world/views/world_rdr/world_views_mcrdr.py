...
conclusion_type = (Cabinet, Drawer, Door, set, list, Fridge, Container, Handle,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Cabinet, Drawer, Door, Fridge, Container, Handle]]:
