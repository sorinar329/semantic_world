...
conclusion_type = (Fridge, set, Container, list, Handle, Door, Cabinet, Drawer,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Fridge, Container, Handle, Door, Cabinet, Drawer]]:
