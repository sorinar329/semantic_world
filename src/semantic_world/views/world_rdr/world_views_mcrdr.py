...
conclusion_type = (Fridge, Container, set, list, Door, Cabinet, Drawer, Handle,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Fridge, Container, Door, Cabinet, Drawer, Handle]]:
