...
conclusion_type = (Door, Drawer, set, Fridge, list, Cabinet, Container, Handle,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Door, Drawer, Fridge, Cabinet, Container, Handle]]:
