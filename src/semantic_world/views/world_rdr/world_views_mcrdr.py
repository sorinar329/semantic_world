...
conclusion_type = (Door, Container, set, list, Drawer, Cabinet, Handle, Fridge,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Door, Container, Drawer, Cabinet, Handle, Fridge]]:
