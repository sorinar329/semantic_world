...
conclusion_type = (Handle, Fridge, Door, set, list, Container, Cabinet, Drawer,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Handle, Fridge, Door, Container, Cabinet, Drawer]]:
