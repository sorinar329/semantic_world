...
conclusion_type = (set, Handle, Drawer, list, Fridge, Container, Cabinet, Door,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Handle, Drawer, Fridge, Container, Cabinet, Door]]:
