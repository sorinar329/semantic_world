...
conclusion_type = (Cabinet, Fridge, Container, Handle, set, list, Door, Drawer,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Cabinet, Fridge, Container, Handle, Door, Drawer]]:
