...
conclusion_type = (set, list, Cabinet, Fridge, Handle, Drawer, Container, Door,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Cabinet, Fridge, Handle, Drawer, Container, Door]]:
