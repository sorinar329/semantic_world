...
conclusion_type = (set, Handle, list, Fridge, Container, Drawer, Cabinet, Door,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Handle, Fridge, Container, Drawer, Cabinet, Door]]:
