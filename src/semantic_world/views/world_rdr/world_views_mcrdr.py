...
conclusion_type = (Fridge, Container, set, Handle, list, Cabinet, Drawer, Door,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Fridge, Container, Handle, Cabinet, Drawer, Door]]:
