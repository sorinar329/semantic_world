...
conclusion_type = (Drawer, Fridge, set, Cabinet, list, Container, Handle, Door,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Drawer, Fridge, Cabinet, Container, Handle, Door]]:
