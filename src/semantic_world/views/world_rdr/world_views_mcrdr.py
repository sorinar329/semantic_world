...
conclusion_type = (Container, Handle, Door, set, list, Cabinet, Drawer, Fridge,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Container, Handle, Door, Cabinet, Drawer, Fridge]]:
