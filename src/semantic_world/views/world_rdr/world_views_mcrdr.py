...
conclusion_type = (set, Drawer, list, Fridge, Container, Handle, Cabinet, Door,)
mutually_exclusive = False


def classify(case: World, **kwargs) -> Set[Union[Drawer, Fridge, Container, Handle, Cabinet, Door]]:
