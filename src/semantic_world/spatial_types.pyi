...
class Expression(Symbol_):
    def __init__(self, data: Optional[Union[Symbol,
                                            Expression,
                                            float,
                                            Vector3, Point3, TransformationMatrix, RotationMatrix, Quaternion,
    ...
    def __add__(self, other: Vector3) -> Vector3: ...
    @overload
    def __add__(self, other: Union[Symbol, Expression, float, TransformationMatrix, RotationMatrix, Quaternion]) -> Expression: ...
    def __radd__(self, other: float) -> Expression: ...
    ...
    def __sub__(self, other: Vector3) -> Vector3: ...
    @overload
    def __sub__(self, other: Union[Symbol, Expression, float, TransformationMatrix, RotationMatrix, Quaternion]) -> Expression: ...
    def __rsub__(self, other: float) -> Expression: ...
    ...
    def __mul__(self, other: Vector3) -> Vector3: ...
    @overload
    def __mul__(self, other: Union[Symbol, Expression, float, RotationMatrix, TransformationMatrix, Quaternion]) -> Expression: ...
    def __rmul__(self, other: float) -> Expression: ...
    ...
    def __truediv__(self, other: Vector3) -> Vector3: ...
    @overload
    def __truediv__(self, other: Union[Symbol, Expression, float, RotationMatrix, TransformationMatrix, Quaternion]) -> Expression: ...
    def __rtruediv__(self, other: float) -> Expression: ...
...
class TransformationMatrix(Symbol_, GeometricType):
    ...
    def from_xyz_rpy(cls,
                     ...
                     reference_frame: Optional[PrefixName] = None,
                     child_frame: Optional[PrefixName] = None) -> TransformationMatrix: ...
    @classmethod
