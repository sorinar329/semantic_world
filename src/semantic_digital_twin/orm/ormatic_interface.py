...
class WorldStateMappingDAO(
    ...
    names: Mapped[List[PrefixedNameDAO]] = relationship(
        "PrefixedNameDAO",
...
class PrefixedNameDAO(
    ...
    worldstatemappingdao_names_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("WorldStateMappingDAO.id", use_alter=True), nullable=True
    )
